...
var NavbarOffcanvas = React89.forwardRef(({
  ...
  return hasExpandProp && shouldExpand ? (0, import_jsx_runtime85.jsx)("div", {
    ref,
    ...props,
    className: (0, import_classnames56.default)(className, bsPrefix, `${bsPrefix}-${placement}`)
  }) : (0, import_jsx_runtime85.jsx)(Offcanvas_default, {
    ref,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime94.jsxs)(import_jsx_runtime93.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react78.cloneElement)(children, triggerProps), (0, import_jsx_runtime92.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
